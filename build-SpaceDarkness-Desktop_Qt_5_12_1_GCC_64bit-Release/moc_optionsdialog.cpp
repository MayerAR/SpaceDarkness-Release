...
#include "../../../../C++/QtCreator/SpaceDarkness/mainController/optionsDialog/optionsdialog.h"
...
QT_MOC_LITERAL(1, 14, 17), // "signalSaveChanges"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 26), // "on_applyPushButton_clicked"
QT_MOC_LITERAL(4, 60, 12) // "changeDialog"

    },
    "optionsDialog\0signalSaveChanges\0\0"
    "on_applyPushButton_clicked\0changeDialog"
};
...
void optionsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalSaveChanges(); break;
        case 1: _t->on_applyPushButton_clicked(); break;
        case 2: _t->changeDialog(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&optionsDialog::signalSaveChanges)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void optionsDialog::signalSaveChanges()
{
